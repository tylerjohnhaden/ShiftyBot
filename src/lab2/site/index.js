class Map {
    constructor(sideLength, maxDelta, robotRadius = 0.04, goalRadius = 0.01) {
...
const map = new Map(document.body.clientHeight * 0.9, maxDelta, goalRadius=goals[0]['radius']);
for (let i = 0; i < goals[0]['points'].length; i++) {
    map.drawGoal(goals[0]['points'][i][0], goals[0]['points'][i][1]);
}
