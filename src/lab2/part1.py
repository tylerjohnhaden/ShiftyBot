...
class Shifty:
    def __init__(self, goal_x=1.5, goal_y=1.5, steering_constant=1):
        self.goal_x = goal_x
        self.goal_y = goal_y
    ...
    def currently_sees_obstacle(self):
        ...
        threshold = self.min_range * (self.cur_velocity / 0.3)
